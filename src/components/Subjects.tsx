  ...
  return (
    <li>
      ...
      <div className="subjects__desc">
        <div
          className={`flex justify-content-between align-items-center ${news ? "mb-3" : ""}`}
        >
        ...
        {news && (
          <p className="flex align-items-center gap-1">
            <i className="bx bx-alert-circle" /> Amigos, temos atualizações
            sobre essa matéria. Fiquem atentos ao mural!
          </p>
        )}
      </div>
    </li>
